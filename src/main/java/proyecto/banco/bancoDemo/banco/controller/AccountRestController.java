...
public class AccountRestController {
  ...
  public static final String BANK_GET_ACCOUNT_CLIENT = "/bank-account/{accountNumber}/client/{idClient}";
  public static final String BANK_GET_CREDIT_CLIENT = "/credit/{accountNumber}/client/{idClient}";
  public static final String BANK_GET_CREDIT_CARD_CLIENT = "/credit-card/{accountNumber}/client/{idClient}";
  ...
  @RequestMapping(AccountRestController.BANK_GET_CREDIT_CLIENT)
  ...
  @RequestMapping(AccountRestController.BANK_GET_CREDIT_CARD_CLIENT)
